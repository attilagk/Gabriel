...
\setcounter{table}{4}
\makeatletter 
\renewcommand{\tablename}{Supplementary Table S} % nice
\makeatother
...
sphingolipids were separated with normal-phase HPLC as described previously,
...
\setcounter{figure}{0}
\makeatletter 
\renewcommand{\figurename}{Supplementary Figure S} % nice
\makeatother
