...
\begin{figure}[p]
	\includegraphics[width=0.7SM['Deg. unsat. ch.1'].unique()5\textwidth]{../../notebooks/2023-01-04-side-chain/named-figure/level-1_sidechain_len-PCe.pdf}
	\caption[PCe level across various side chain lengths and degrees of unsaturation]{
	PCe level across various side chain lengths and degrees of unsaturation.
}
\label{fig:sidechain-SM}
\end{figure}
